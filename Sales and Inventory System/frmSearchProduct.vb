...
Public Class frmSearchProduct
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmOrder.txtWeight.Text = dr.Cells(4).Value()
            frmOrder.txtPrice.Text = dr.Cells(5).Value()
            frmOrder.txtAvailableCartons.Text = dr.Cells(6).Value()
            frmOrder.txtAvailablePackets.Text = dr.Cells(8).Value()

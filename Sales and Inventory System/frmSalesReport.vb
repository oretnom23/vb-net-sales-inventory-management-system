...
Public Class frmSalesReport
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            MyCommand.CommandText = "select * from Billinfo where BillingDate between #" & dtpInvoiceDateFrom.Value & "# And #" & dtpInvoiceDateTo.Value & "# order by BillingDate"
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Try
            ...
            myConnection = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\SI_DB.accdb;Persist Security Info=False;")
            MyCommand.Connection = myConnection
            MyCommand.CommandText = "select * from Billinfo where PaymentDue > 0 and BillingDate between #" & DateTimePicker2.Value & "# And #" & DateTimePicker1.Value & "#  order by BillingDate"
